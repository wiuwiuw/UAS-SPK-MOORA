...
$data_subkriteria = tampilsubkriteria("SELECT * FROM sub_kriteria INNER JOIN kriteria ON sub_kriteria.id_kriteria = kriteria.id_kriteria");
...
<form method="post" action="perhitungan.php">
  ...
  <div class="container bg-light shadow p-3 mb-5">
    <div class="alert alert-info">
      <center><b>DATA SUB KRITERIA</b></center>
    </div>

  <a href="tambah_data_subkriteria.php" class="btn btn-dark">Tambah Data</a>
  <br>
    <div class="table-responsive p-4">
      ...
      <thead class="custom-table-header">
        ...
        <?php $i = 1; ?>
        <?php foreach ($data_subkriteria as $data) { ?>
          <tr>
            <td><?= $i++; ?></td>
            <td><?= $data['kriteria']; ?></td>
            <td><?= $data['nilai']; ?></td>
            <td><?= $data['bobot_subkriteria']; ?></td>
            <td><a href="edit_data_subkriteria.php?id_subkriteria=<?= $data['id_subkriteria']; ?>" class="btn btn-warning">Edit</a>
             <a href="hapus_data_subkriteria.php?id_subkriteria=<?= $data['id_subkriteria']; ?>" class="btn btn-danger">Delete</a></td>
          </tr>
        <?php } ?>
      </table>
    </div>
