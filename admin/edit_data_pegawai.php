...
//AMBIL DATA YG DIKLIK EDIT DI HALAMAN data_pegawai.php TADI 
$id_alternatif = $_GET['id_alternatif'];

//TAMPILKAN DATA DIMANA id_alternatif nya ADALAH $id_alternatif
$data_pegawai = tampilpegawai("SELECT * FROM alternatif WHERE id_alternatif = '$id_alternatif' ")[0];
    ...
    <div class="col-md-7">
      <form method="post" class="form-group">
        <table class="table">
          ...
          <tr>
            <td width="200"><label>Id Pegawai</label></td>
            <td> : </td>
            <td width="500"><input type="text" name="id_alternatif" value="<?= $data_pegawai['id_alternatif']; ?>" readonly class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Nama Pegawai</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="nama_pegawai" value="<?= $data_pegawai['nama_pegawai']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Pengalaman Kerja (C1)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="k1" value="<?= $data_pegawai['k1']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Tanggung Jawab (C2)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="k2" value="<?= $data_pegawai['k2']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Komunikasi (C3)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="k3" value="<?= $data_pegawai['k3']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Wawasan (C4)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="k4" value="<?= $data_pegawai['k4']; ?>" class="form-control" autocomplete="off"></td>
          </tr>

          <tr>
            <td><label>Penampilan (C5)</label></td>
            <td> : </td>
            <td width="500"> <input type="text" name="k5" value="<?= $data_pegawai['k5']; ?>" class="form-control" autocomplete="off"></td>
          </tr>
