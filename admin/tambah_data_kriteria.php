...
if (isset($_POST['simpan'])) {
  //JIKA function tambah_kriteria > 0 (sukses) MAKA JALANKAN FUNGSI
  if (tambah_kriteria($_POST) > 0) {
    //DAN TAMPILKAN POP UP "DATA BERHASIL DI TAMBAH DAN LEMPAR KE HALAMAN data_kriteria.php"
    echo "<script>
...
<form method="post" action="perhitungan.php">
  ...
  <div class="container bg-light shadow p-3 mb-5">
    <div class="alert alert-info">
      <center><b>TAMBAH DATA KRITERIA</b></center>
    </div>
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td> : </td>
              <td width="500"><input type="text" name="id_kriteria" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Nama Kriteria</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="kriteria" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Bobot</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="bobot" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Tipe (Benefit/Cost)</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="type" class="form-control" autocomplete="off"></td>
            </tr>
