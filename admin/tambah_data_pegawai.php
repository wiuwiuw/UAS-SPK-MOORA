...
if (isset($_POST['simpan'])) {
  //JIKA function tambah_pegawai > 0 (sukses) MAKA JALANKAN FUNGSI
  if (tambah_pegawai($_POST) > 0) {
    //DAN TAMPILKAN POP UP "DATA BERHASIL DI TAMBAH DAN LEMPAR KE HALAMAN data_pegawai.php"
    echo "<script>
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td> : </td>
              <td width="500"> <input type="text" name="nama_pegawai" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Pengalaman Kerja (K1)</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="k1" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Tanggung Jawab (K2)</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="k2" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Komunikasi (K3)</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="k3" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Wawasan (K4)</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="k4" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Penampilan (K5)</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="k5" class="form-control" autocomplete="off"></td>
            </tr>


            <td></td>
            <td></td>
            <td><button type="submit" name="simpan" class="btn btn-dark">Simpan</button> &nbsp;&nbsp;&nbsp;
