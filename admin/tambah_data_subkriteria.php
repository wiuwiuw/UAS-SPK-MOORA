...
if (isset($_POST['simpan'])) {
  //JIKA function tambah_subkriteria > 0 (sukses) MAKA JALANKAN FUNGSI
  if (tambah_subkriteria($_POST) > 0) {
    //DAN TAMPILKAN POP UP "DATA BERHASIL DI TAMBAH DAN LEMPAR KE HALAMAN data_subkriteria.php"
    echo "<script>
...
<body bgcolor="f0f0f0">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav" style="margin: 10px;">
          ...
          <a class="nav-link" href="data_subkriteria.php">
            <font size="4"><b>Sub Kriteria</b></font>
          </a>
  ...
  <div class="container bg-light shadow p-3 mb-5">
    <div class="alert alert-info">
      <center><b>TAMBAH DATA SUB KRITERIA</b></center>
    </div>
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tr>
              ...
              <td> : </td>
              <td width="500"><input type="text" name="id_subkriteria" class="form-control" autocomplete="off"></td>
            </tr>
            ...
            <tr>
              ...
              <td> : </td>
              <td width="500">
                <select name="id_kriteria" class="form-control black-text" autocomplete="off">
                  <?php
            ...
            <tr>
              ...
              <td> : </td>
              <td width="500"> <input type="text" name="nilai" class="form-control" autocomplete="off"></td>
            </tr>

            <tr>
              <td><label>Bobot Sub Kriteria</label></td>
              <td> : </td>
              <td width="500"> <input type="text" name="bobot_subkriteria" class="form-control" autocomplete="off"></td>
            </tr>
